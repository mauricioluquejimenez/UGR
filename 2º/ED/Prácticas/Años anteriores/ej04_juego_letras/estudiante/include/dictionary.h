...
public:
     ...
     * @param Characters Conjunto de caracteres disponibles, pasados todos a minúscula
     * @param curr_node Nodo actual del árbol
     * @param word Cadena (palabra) actualmente formada
     * @return
     */
    vector<string> createWords(vector<char> & Characters, Dictionary::node curr_node, string word);

    /**
     * @brief Función auxiliar que calcula palabras posibles a partir del conjunto de caracteres disponibles
     * @param available_characters Conjunto de caracteres disponibles
     * @return Vector de palabras generadas
     */
    vector<string> getWords(const vector<char> & available_characters);
    ...
    public:
        ...
        iterator(Dictionary::iterator const & i);
