...
private:
    ...
    bool  button_press; //True si fue pulsado el boton derecho del raton false 				//en otro caso	
    QSize icon_size;
public:
    /**
     ...
     * @param button: true si se ha pulsado el boton derecho false el izquierdo
    */
    void getCasillaElegida(int &r,int &c,bool & button);
   ...
   /**
     * @brief Escribe un texto en una casiilla
     * @param r: fila de la casilla
     * @param c: columna de la casilla
     * @param texto: mensaje a escribir en la casilla
     */
      void putTexto(int r,int c,const string &text);
