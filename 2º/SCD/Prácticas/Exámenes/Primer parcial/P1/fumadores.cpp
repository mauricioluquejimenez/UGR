...
void funcion_hebra_estanquero(  )
{
	...
	while(true)
	{
      ...
      /* Se produce un ingrediente una vez es securo que no va a estar vacío ni se va a extraer nada de él*/
...
void  funcion_hebra_fumador( int num_fumador )
{
   while( true )
   {
      ...
      /* Una vez el fumador ha extraído el ingrediente y se ha dejado el mostrador vacío, el propio fumador procede a fumar */
		fumar(num_fumador);
