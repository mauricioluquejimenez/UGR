...
<html lang = "es">
    <head>
        <title> MRG | Decoraciones para las fiestas del Corpus </title>
        <base href = "../pe2/">
    ...
    <body>
        ...
        <div id = "contenido">
            <main id = "obras_coleccion">
                <figure id = "obra">
                    <figcaption id = "titulo_obras"> Decoraciones para las fiestas del Corpus, J. Ruano (1850) </figcaption>
                    <img src = "../../imagenes/obras/obra17.jpg" alt = "Decoraciones para las fiestas del Corpus">
                </figure>
