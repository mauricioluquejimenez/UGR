...
<html lang = "es">
    <head>
        <title> MRG | Retrato del duque de San Pedro de Galatino </title>
        <base href = "../pe2/"> 
    ...
    <body>
        ...
        <div id = "contenido">
            <main id = "obras_coleccion">
                <figure id = "obra">
                    <figcaption id = "titulo_obras"> Retrato del duque de San Pedro de Galatino, Gabriel Morcillo Raya (1922) </figcaption>
                    <img src = "../../imagenes/obras/obra4.jpg" alt = "La plaza de Bib-Rambla">
                </figure>

                <p id = "descripcion"> Un elegante retrato que muestra al duque, una figura prominente de la sociedad granadina, destacando su estatus y refinamiento. </p>
            </main>        
