...
<html lang = "es">
    <head>
        <title> MRG | Aparición de la Virgen a San Jacinto </title>
        <base href = "../pe2/"> 
    ...
    <body>
        ...
        <div id = "contenido">
            <main id = "obras_coleccion">
                <figure id = "obra">
                    <figcaption id = "titulo_obras"> Aparición de la Virgen a San Jacinto, Pedro de Raxis (1600) </figcaption>
                    <img src = "../../imagenes/obras/obra13.jpg" alt = "Aparición de la Virgen a San Jacinto">
                </figure>

                <p id = "descripcion"> Captura un milagro mariano, resaltando la influencia de la fe en el arte del siglo XVII. </p>
            </main>        
