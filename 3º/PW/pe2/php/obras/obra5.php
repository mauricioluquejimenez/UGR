...
<html lang = "es">
    <head>
        <title> MRG | Retrato de dama con loro </title>
        <base href = "../pe2/"> 
    ...
    <body>
        ...
        <div id = "contenido">
            <main id = "obras_coleccion">
                <figure id = "obra">
                    <figcaption id = "titulo_obras"> Retrato de dama con loro, Joaquín de la Rosa (1839) </figcaption>
                    <img src = "../../imagenes/obras/obra5.jpg" alt = "Retrato de dama con loro">
                </figure>

                <p id = "descripcion"> Esta obra destaca por su detalle íntimo y la inclusión de un loro, simbolizando quizás el exotismo y la riqueza. </p>
            </main>        
        ...
        <li>
            <a href = "../obras/obra10.php"><img src = "../../imagenes/obras/obra10.jpg" alt = "Inmaculada Concepción"></a>
            <h4> Inmaculada Concepción </h4>
            <h4> Fray Juan Sánchez Cotán </h4>
            <h4> 1617-1618 </h4>
        </li>
