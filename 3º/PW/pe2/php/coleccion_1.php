            ...
            <main id = "obras_coleccion">
                ...
                <div class = "row">
                    <figure class = "obra_coleccion">
                        ...
                        <a href = "../php/obras/obra1.php"><img src = "../imagenes/obras/obra1.jpg" alt = "Retrato de Ángel Ganivet"></a>
                    </figure>
	                
    
                    <figure class = "obra_coleccion">
                        <figcaption> Danza del bolero en Granada, Dutailly (1805) </figcaption>
                        <a href = "../php/obras/obra2.php"><img src = "../imagenes/obras/obra2.jpg" alt = "Danza del bolero en Granada"></a>
                    </figure>
    
                    <figure class = "obra_coleccion">
                        <figcaption> La plaza de Bib-Rambla, Luis Muriel (1834) </figcaption>
                        <a href = "../php/obras/obra3.php"><img src = "../imagenes/obras/obra3.jpg" alt = "La plaza de Bib-Rambla"></a>
                    </figure>
                </div>
                ...
                <div class = "row">
                    <figure class = "obra_coleccion">
                        ...
                        <a href = "../php/obras/obra4.php"><img src = "../imagenes/obras/obra4.jpg" alt = "Retrato del duque de San Pedro de Galatino"></a>   
                    </figure>
    
                    <figure class = "obra_coleccion">
                        <figcaption> Retrato de dama con loro, Joaquín de la Rosa (1839) </figcaption>
                        <a href = "../php/obras/obra5.php"><img src = "../imagenes/obras/obra5.jpg" alt = "Retrato de dama con loro"></a>
                    </figure>
    
                    <figure class = "obra_coleccion">
                        <figcaption> Monumento a Isidoro Máiquez, F. Pérez (1838) </figcaption>
                        <a href = "../php/obras/obra6.php"><img src = "../imagenes/obras/obra6.jpg" alt = "Monumento a Isidoro Máiquez"></a>
                    </figure>
                </div>
    
                <div class = "row">
                    <figure class = "obra_coleccion">
                        <figcaption> Sereno, Luis Muriel (1834) </figcaption>
                        <a href = "../php/obras/obra7.php"><img src = "../imagenes/obras/obra7.jpg" alt = "Sereno"></a>
                    </figure>
    
                    <figure class = "obra_coleccion">
                        <figcaption> Ayuntamiento Viejo de Granada, Mariano Fortuny y Marsal (1873) </figcaption>
                        <a href = "../php/obras/obra8.php"><img src = "../imagenes/obras/obra8.jpg" alt = "Ayuntamiento Viejo de Granada"></a>
                    </figure>
    
                    <figure class = "obra_coleccion">
                        <figcaption> Francisco Chacón, La Quinta Angustia (1492) </figcaption>
                        <a href = "../php/obras/obra9.php"><img src = "../imagenes/obras/obra9.jpg" alt = "La Quinta Angustia"></a>
                    </figure>
                </div>
                ...
                <div class = "row">
                    <figure class = "obra_coleccion">
                        ...
                        <a href = "../php/obras/obra10.php"><img src = "../imagenes/obras/obra10.jpg" alt = "Inmaculada Concepción"></a>
                    </figure>
    
                    <figure class = "obra_coleccion">
                        <figcaption> San Juan Evangelista en la isla de Patmos, Alonso Cano (1645) </figcaption>
                        <a href = "../php/obras/obra11.php"><img src = "../imagenes/obras/obra11.jpg" alt = "San Juan Evangelista en la isla de Patmos"></a>
                    </figure>
    
                    <figure class = "obra_coleccion">
                        <figcaption> El Entierro de Cristo, Jacobo Florentino, el Indaco (1521-1526) </figcaption>
                        <a href = "../php/obras/obra12.php"><img src = "../imagenes/obras/obra12.jpg" alt = "El Entierro de Cristo"></a>
                    </figure>
                </div>
    
                <p style = "font-size: 1em; padding: 1%; text-align: center;"><a href = "../php/coleccion_2.php" > Página siguiente </a></p>
            </main>
        </div>
