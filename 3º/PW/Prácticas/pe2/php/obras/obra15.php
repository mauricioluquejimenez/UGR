...
<html lang = "es">
    <head>
        <title> MRG | San Juan de Capistrano y San Bernardino de Siena </title>
        <base href = "../pe2/">
    ...
    <body>
        ...
        <div id = "contenido">
            <main id = "obras_coleccion">
                <figure id = "obra">
                    <figcaption id = "titulo_obras"> San Juan de Capistrano y San Bernardino de Siena, Alonso Cano (1652-1657) </figcaption>
                    <img src = "../../imagenes/obras/obra15.jpg" alt = "San Juan de Capistrano y San Bernardino de Siena">
                </figure>

                <p id = "descripcion"> Presenta a dos santos importantes de la Iglesia, enfatizando su santidad y carácter ascético. </p>
            </main>        
