...
<html lang = "es">
    <head>
        <title> MRG | Danza del bolero en Granada </title>
        <base href = "../pe2/"> 
    ...
    <body>
        ...
        <div id = "contenido">
            <main id = "obras_coleccion">
                <figure id = "obra">
                    <figcaption id = "titulo_obras"> Danza del bolero en Granada, Dutailly (1805) </figcaption>
                    <img src = "../../imagenes/obras/obra2.jpg" alt = "Danza del bolero en Granada">
                </figure>

                <p id = "descripcion"> Representa una escena vibrante de danza popular, capturando el movimiento y el espíritu festivo típico de Granada en esa época.</p>
            </main>
