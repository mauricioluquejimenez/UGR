...
<html lang = "es">
    <head>
        <title> MRG | La Quinta Angustia </title>
        <base href = "../pe2/"> 
    ...
    <body>
        ...
        <div id = "contenido">
            <main id = "obras_coleccion">
                <figure id = "obra">
                    <figcaption id = "titulo_obras"> La Quinta Angustia, Francisco Chacón (1492) </figcaption>
                    <img src = "../../imagenes/obras/obra9.jpg" alt = "La Quinta Angustia">
                </figure>
