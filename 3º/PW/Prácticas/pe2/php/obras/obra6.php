...
<html lang = "es">
    <head>
        <title> MRG | Monumento a Isidoro Máiquez </title>
        <base href = "../pe2/"> 
    ...
    <body>
        ...
        <div id = "contenido">
            <main id = "obras_coleccion">
                <figure id = "obra">
                    <figcaption id = "titulo_obras"> Monumento a Isidoro Máiquez, F. Pérez (1838) </figcaption>
                    <img src = "../../imagenes/obras/obra6.jpg" alt = "Monumento a Isidoro Máiquez">
                </figure>

                <p id = "descripcion"> Rinde homenaje a Isidoro Máiquez, un renombrado actor español, destacando su contribución al teatro español. </p>
            </main>        
