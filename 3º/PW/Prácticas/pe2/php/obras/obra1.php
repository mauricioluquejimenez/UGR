...
<html lang = "es">
    <head>
        <title> MRG | Retrato de Ángel Ganivet </title>
        <base href = "../pe2/"> 
    ...
    <body>
        ...
        <div id = "contenido">
            <main id = "obras_coleccion">
                <figure id = "obra">
                    <figcaption id = "titulo_obras"> Retrato de Ángel Ganivet, José Ruiz de Almodóvar (Siglo XIX) </figcaption>
                    <img src = "../../imagenes/obras/obra1.jpg" alt = "Retrato de Ángel Ganivet">
                </figure>

                <p id = "descripcion"> Este retrato captura a Ángel Ganivet, considerado un influyente pensador y escritor granadino. La obra refleja la seriedad y profundidad de un personaje central en la cultura española de finales del siglo XIX.</p>
            </main>
