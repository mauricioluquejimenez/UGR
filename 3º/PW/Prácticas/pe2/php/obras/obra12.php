...
<html lang = "es">
    <head>
        <title> MRG | El Entierro de Cristo, Jacobo Florentino </title>
        <base href = "../pe2/"> 
    ...
    <body>
        ...
        <div id = "contenido">
            <main id = "obras_coleccion">
                <figure id = "obra">
                    <figcaption id = "titulo_obras"> El Entierro de Cristo, Jacobo Florentino, el Indaco (1521-1526) </figcaption>
                    <img src = "../../imagenes/obras/obra12.jpg" alt = "El Entierro de Cristo">
                </figure>

                <p id = "descripcion"> Una representación poderosa de un momento clave del cristianismo, mostrando la técnica y emoción del Renacimiento. </p>
            </main>        
