...
float material1_shininess  = 128.0f;

float material2_diffuse[]  = {1.0f, 0.0f, 0.0f, 1.0f};  // Verde
float material2_specular[] = {0.3f, 0.3f, 0.3f, 1.0f};  // Brillo medio
float material2_ambient[]  = {0.05f, 0.1f, 0.05f, 1.0f};
float material2_shininess  = 65.0f;   // Menos brillante
...
float material3_shininess  = 8.0f;    // Mate
...
void DibujaEscena(bool seleccion)
{
  ...
  /*float yellow[4] = {0.25f, 0.25f, 0.0f, 1};*/
  float selectedGrey[4] = {0.25f, 0.25f, 0.25f, 1};
  float selectedRed[4] = {1.0f, 0.1f, 0.1f, 1};
  float selectedGreen[4] = {0.75f, 1.0f, 0.75f, 1};
  /*float selectedYellow[4] = {0.5f, 0.75f, 0.25f, 1};*/
  ...
  /*glPushMatrix();
    ...
    glScalef(20.0f, 0.15f, 5.0f);
    
    if (idSeleccionado == road.getIdSeleccion()) glMaterialfv(GL_FRONT, GL_AMBIENT_AND_DIFFUSE, selectedYellow);
    else glMaterialfv(GL_FRONT, GL_AMBIENT_AND_DIFFUSE, blue);
...
void idle (int v)
{
  switch(idSeleccionado)
  {
    ...
    case 2:
      baymax.animacion(baymax_x, baymax_z, baymax_rotacion, -5.0);  
    break;
  }
