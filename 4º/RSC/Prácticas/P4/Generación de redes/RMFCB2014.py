...
parser = Sbopen()
df, related, freeze, tactics = parser.event(267085)
...
name_replacements = {  
    ...
    'Asier Illarramendi Andonegi': 'Asier Illaramendi',
...
fig.text(s='El Clásico 2014/2015', x = 0.06, y=0.90, fontsize=12)
plt.show()

G = nx.Graph()
G = nx.from_pandas_edgelist(df_away_pass, 'player_name', 'pass_recipient_name', 'x')
nx.write_gexf(G, "RMFCB2014.gexf")