...
fig.text(s=ateam + " "+ "Passing Networks", x= 0.06, y= 0.95, fontsize=18,fontweight="bold")
fig.text(s='Final Champions League 2016/2017', x = 0.06, y=0.90, fontsize=12)
plt.show()

G = nx.Graph()
G = nx.from_pandas_edgelist(df_away_pass, 'player_name', 'pass_recipient_name', 'x')
nx.write_gexf(G, "RMJUV2017.gexf")