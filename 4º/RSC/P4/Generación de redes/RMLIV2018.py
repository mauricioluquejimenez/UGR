...
fig.text(s='Final Champions League 2017/2018', x = 0.06, y=0.90, fontsize=12)
plt.show()

G = nx.Graph()
G = nx.from_pandas_edgelist(df_home_pass, 'player_name', 'pass_recipient_name', 'x')
nx.write_gexf(G, "RMLIV2018.gexf")