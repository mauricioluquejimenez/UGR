...
public class indice {
    ...
    String DocPath = "/home/mauricio/Capitulos";
    IndexWriter writer;
            ...
            if (file.isFile() && file.getName().endsWith(".csv")) {
                try {
                    ...
                    try (CSVReader reader = new CSVReaderBuilder(new FileReader(file))
                        ...
                        doc.add(new TextField("number", data[2], Field.Store.YES));
                        doc.add(new TextField("timestamp_in_ms", data[3], Field.Store.YES));
                        doc.add(new TextField("raw_character_text",data[4], Field.Store.YES));
                        doc.add(new TextField("raw_location_text", data[5], Field.Store.YES));
                        doc.add(new TextField("spoken_words", data[6], Field.Store.YES));
